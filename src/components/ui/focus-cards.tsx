...
export const Card = React.memo(
  ({
    ...
    <div
      ...
      className={cn(
        'relative h-60 w-full overflow-hidden rounded-lg bg-gray-100 transition-all duration-300 ease-out dark:bg-black-100 md:h-96',
...
export function FocusCards({ cards }: { cards: Card[] }) {
  ...
  return (
    <div className='mx-auto grid w-full max-w-6xl grid-cols-1 gap-10 md:grid-cols-4 md:px-8'>
